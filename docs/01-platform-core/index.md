# Platform Core — Vue d'ensemble

## 1. Vision

Le Platform Core de Lumina est un ensemble de **5 moteurs configurables** qui rendent l'application agnostique par rapport au type d'organisation. Ces moteurs interprètent la configuration du manifeste au lieu d'exécuter uniquement du code écrit à l'avance.

Le Platform Core n'est pas un langage de programmation. Ce n'est pas un framework complet. C'est un noyau léger de 5 composants qui permet à Lumina de s'adapter à toute organisation sans modification du code.
...
### Ce que le Platform Core ne fait PAS
...
Seules les étapes 1, 2, 4, 6, 9 passent par le Platform Core. Tout le reste est du code classique.
